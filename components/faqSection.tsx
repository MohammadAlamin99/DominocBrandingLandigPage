          ...
          {faqs.map((faq, index) => {
            ...
            return (
              <div
                ...
                className="bg-white border border-[#E0E6EB] rounded-[8px] overflow-hidden"
              >
                {/* Question */}
                <button
                  onClick={() => toggle(index)}
                  className="w-full flex items-center justify-between text-left px-5 py-4 border-[0.5px] rounded-b-lg"
                >
                ...
                >
                  <div className="px-6 pb-5">
                    <p className="text-sm text-[#98A4AE] leading-relaxed pt-5">
                      {faq.answer}
                    </p>
                  </div>
                </div>
